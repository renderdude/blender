...
if(WITH_CYCLES AND WITH_CYCLES_DISTRIBUTED)
  find_package(MPI REQUIRED)
  message(STATUS "Found MPI: ${MPI_C_LIBRARIES}")

  find_package(cppzmq REQUIRED)
  if (IS_SYMLINK "${cppzmq_INCLUDE_DIR}/zmq.hpp")
    FILE(REAL_PATH "${cppzmq_INCLUDE_DIR}/zmq.hpp" foo)
    cmake_path(GET foo PARENT_PATH cppzmq_INCLUDE_DIR)
    FILE(REAL_PATH "${ZeroMQ_INCLUDE_DIR}/zmq.h" foo)
    cmake_path(GET foo PARENT_PATH ZeroMQ_INCLUDE_DIR)
    FILE(REAL_PATH "${ZeroMQ_LIBRARY}" ZeroMQ_LIBRARY)
  endif()
  message(STATUS "Found cppzmq includes: ${cppzmq_INCLUDE_DIR}")
